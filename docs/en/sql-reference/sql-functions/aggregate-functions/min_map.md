...
DECIMAL32/64/128, CHAR, VARCHAR, DATE, and DATETIME. DECIMAL256 keys are not supported.

Supported value types are BOOLEAN, integer types, FLOAT, DOUBLE, DECIMALV2, DECIMAL32/64/128/256, CHAR, VARCHAR,
DATE, and DATETIME.
